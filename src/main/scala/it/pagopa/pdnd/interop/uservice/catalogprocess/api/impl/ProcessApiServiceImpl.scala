...
import it.pagopa.pdnd.interop.uservice.catalogprocess.common.system.validateBearer
...
final case class ProcessApiServiceImpl(
  ...
  override def deleteDraft(eServiceId: String, descriptorId: String)(implicit
    ...
    onComplete(result) {
      ...
      case Failure(ex: ApiError[_]) if ex.code == 400 =>
        logger.error(
          "Error while deleting draft descriptor {} for e-service {} - {}",
          eServiceId,
          descriptorId,
          ex.getMessage
        )
  ...
  override def getEServices(producerId: Option[String], consumerId: Option[String], status: Option[String])(implicit
    ...
    onComplete(result) {
      ...
      case Failure(ex) =>
        ...
        val error =
          problemOf(StatusCodes.InternalServerError, "0005", ex, s"Unexpected error while retrieving E-Services")
        complete(error.status, error)
    }
  }
  ...
  override def publishDescriptor(eServiceId: String, descriptorId: String)(implicit
    ...
    onComplete(result) {
      ...
      case Failure(ex: ApiError[_]) if ex.code == 400 =>
        logger.error(
          "Error while publishing descriptor {} for eservice {} - {}",
          descriptorId,
          eServiceId,
          ex.getMessage
        )
  ...
  override def getEServiceById(eServiceId: String)(implicit
    ...
    onComplete(result) {
      ...
      case Failure(ex) =>
        logger.error("Error while getting e-service {} - {}", eServiceId, ex.getMessage)
        val error =
          problemOf(StatusCodes.InternalServerError, "0009", ex, s"Unexpected error retrieving E-Service $eServiceId")
        complete(error.status, error)
    }
  }
      ...
      case Failure(ex) =>
        ...
        val error =
          problemOf(
            ...
            "0016",
            ex,
            s"Unexpected error while retrieving flatted E-Services"
          )
        complete(error.status, error)
    }
  }
  ...
  override def createDescriptor(eServiceId: String, eServiceDescriptorSeed: EServiceDescriptorSeed)(implicit
    ...
    onComplete(result) {
      ...
      case Failure(ex) =>
        logger.error("Error while creating descriptor for e-service {} - {}", eServiceId, ex.getMessage)
        val errorResponse: Problem =
          problemOf(StatusCodes.BadRequest, "0017", ex, s"Error while creating Descriptor for e-service Id $eServiceId")
  ...
  override def updateDraftDescriptor(
    ...
    onComplete(result) {
      ...
      case Failure(ex) =>
        logger.error(
          "Error while updating draft descriptor {} of e-service {} - {}",
          descriptorId,
          eServiceId,
          ex.getMessage
        )
        val errorResponse: Problem =
          problemOf(
            ...
            "0018",
            ex,
            s"Error while updating draft Descriptor for e-service Id $eServiceId"
          )
  ...
  override def updateEServiceById(eServiceId: String, updateEServiceSeed: UpdateEServiceSeed)(implicit
    ...
    onComplete(result) {
      ...
      case Failure(ex) =>
        logger.error("Error while updating e-service by id {} - {}", eServiceId, ex.getMessage)
        val errorResponse: Problem =
          problemOf(StatusCodes.BadRequest, "0019", ex, s"Error while creating Descriptor for e-service Id $eServiceId")
        createDescriptor400(errorResponse)
    }
  }
  ...
  override def cloneEServiceByDescriptor(eServiceId: String, descriptorId: String)(implicit
    ...
    onComplete(result) {
      ...
      case Failure(ex) =>
        logger.error("Error while cloning descriptor {} of e-service {} - {}", descriptorId, eServiceId, ex.getMessage)
        val errorResponse: Problem =
          problemOf(
            StatusCodes.BadRequest,
            "0026",
  ...
  override def deleteEService(
    ...
    onComplete(result) {
      ...
      case Failure(ex) =>
        logger.error("Error while deleting e-service {} - {}", eServiceId, ex.getMessage)
        val error =
          problemOf(StatusCodes.InternalServerError, "0027", ex, s"Error while deleting E-service $eServiceId")
        complete(error.status, error)
    }
  }
  ...
  override def activateDescriptor(eServiceId: String, descriptorId: String)(implicit
    ...
    onComplete(result) {
      ...
      case Failure(ex: NotValidDescriptor) =>
        logger.error("Activating descriptor {} for e-service {} - {}", descriptorId, eServiceId, ex.getMessage)
