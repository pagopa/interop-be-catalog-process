...
object PagopaVersions {
  lazy val agreementManagementVersion         = "1.0.2"
  lazy val attributeRegistryManagementVersion = "1.0.2"
  lazy val catalogManagementVersion           = "1.0.3"
  lazy val commonsVersion                     = "1.0.5"
  lazy val partyManagementVersion             = "1.0.0"
  lazy val authorizationManagementVersion     = "1.0.2"
}
